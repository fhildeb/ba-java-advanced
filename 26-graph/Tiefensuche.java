...
/**
* Rahmenklasse für einen Algorithmus zur Tiefensuche.
*
*/
...
public Tiefensuche(Graph G, int s){
 // Hier müssen noch die Attribute der Klasse initialisiert werden
suche(G, s);
}
/**
...
/**
* Gibt die Anzahl der Knoten zurück, die mit dem Start-Knoten <tt>s</tt> verbunden sind.
...
public boolean marked(int v) {
	return false;
 // bitte ergänzen Tipp: Wenn ein Knoten markiert ist, so kann er von s aus auch erreicht werden
}
}
